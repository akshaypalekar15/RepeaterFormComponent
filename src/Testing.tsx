...
const TestingComponent = (): JSX.Element => {
  const getRepeaterState: any = (
    rState: SetStateAction<never[]>,
    repeatedElements: any[]
  ) => {
    console.log(rState, repeatedElements);
  };
  return (
    <Repeater
      component={<InputComponent />} // May pass any form component
      enableRemove={false} // Enable remove node button
      clearAll={false} // Enable clear all nodes
